...
public class CategoryAddDialog extends Dialog implements View.OnClickListener {
    ...
    private List<CategoryAddModel>VratiListuIkona(){
        String ikone[] = {"ic_book","ic_fitness","ic_gaming","ic_kucni_ljubimci","ic_lijekovi","ic_obrazovanje","ic_pokloni","ic_travelling","ic_bank","ic_coffee","ic_growth","ic_money_transfer","ic_life_insurance"};
