...
import air.foi.hr.core.database.dao.CiljeviDAO;
...
@Database(entities = {DnevnikRada.class, KategorijaTransakcije.class, Korisnik.class, KorisnikoveValute.class, Podsjetnik.class, Racun.class,RadnjaDnevnika.class,
        Transakcija.class, Valuta.class, Ciljevi.class},version=MyDatabase.VERSION,exportSchema = false)
public abstract class MyDatabase extends RoomDatabase {
    ...
    public abstract CiljeviDAO getCiljeviDAO();
